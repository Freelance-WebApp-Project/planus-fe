    ...
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.userName}>{user?.fullName || 'Chưa cập nhật'}</Text>
          ...
          <View style={styles.walletCard}>
            <View style={styles.walletInfo}>
              ...
              <View style={styles.walletDetails}>
                ...
                <Text style={styles.walletSubtitle}>Quản lý tài chính của bạn</Text>
              </View>
            </View>
            <TouchableOpacity 
            ...
            <ScrollView style={styles.modalBody} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.genderContainer}>
                  ...
                  >
                    <Text style={[
                      ...
                      editData.gender === 'male' && styles.genderButtonTextSelected
                    ]}>
                      Nam
                    </Text>
                  </TouchableOpacity>
                  ...
                  >
                    <Text style={[
                      styles.genderButtonText,
                      editData.gender === 'female' && styles.genderButtonTextSelected
                    ]}>
                      Nữ
                    </Text>
                  </TouchableOpacity>
              ...
              <View style={styles.inputGroup}>
                ...
                <TextInput
                  ...
                  onChangeText={(text) => setEditData({...editData, income: text})}
