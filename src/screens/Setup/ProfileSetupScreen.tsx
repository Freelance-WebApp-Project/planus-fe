            ...
            {interests.map((interest, index) => (
              <TouchableOpacity
                ...
                style={[
                  ...
                  selectedInterests.includes(interest.value) && styles.interestButtonSelected
                ]}
                onPress={() => toggleInterest(interest.value)}
              >
                <Text style={[
                  styles.interestText,
                  selectedInterests.includes(interest.value) && styles.interestTextSelected
                ]}>
                  {interest.label}
                </Text>
              </TouchableOpacity>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            <View style={styles.modalHeader}>
              ...
              >
                <Text style={[styles.modalButtonText, styles.modalButtonPrimary]}>Xong</Text>
              </TouchableOpacity>
            </View>
              ...
              <View style={styles.yearSection}>
                ...
                <View style={styles.yearControls}>
                  ...
                  <View style={styles.currentValue}>
                    <Text style={styles.currentValueText}>{tempDate.getFullYear()}</Text>
                  </View>
                  <TouchableOpacity
                    style={styles.controlButton}
                    onPress={() => {
              ...
              <View style={styles.daySection}>
                ...
                <View style={styles.dayGrid}>
                  {Array.from({ length: 31 }, (_, i) => {
                    ...
                    const isValidDay = new Date(tempDate.getFullYear(), tempDate.getMonth() + 1, 0).getDate() >= day;
